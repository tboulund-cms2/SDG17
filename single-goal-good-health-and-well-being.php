        ...
        <div class="row action-items-section d-flex flex-row flex-wrap ">
            <div class="item-group-1 mb-5">
                <div class="item-image item-image-1">
                    <?php echo wp_get_attachment_image(337, array('420', '280')); ?>
                </div>  
                <h3 class="my-2">
            ...
            <div class="item-group-2 mb-5">
                <div class="item-image item-image-2">
                    <?php echo wp_get_attachment_image(338, array('420', '280')); ?>
                </div>  
                <h3 class="my-2">
            ...
            <div class="item-group-3 mb-5">
                <div class="item-image item-image-3">
                    <?php echo wp_get_attachment_image(339, array('420', '280')); ?>
                </div>  
                <h3 class="my-2">
            ...
            <div class="item-group-4">
                <div class="item-image item-image-4">
                    <?php echo wp_get_attachment_image(340, array('420', '280')); ?>
                </div>  
                <h3 class="my-2">
